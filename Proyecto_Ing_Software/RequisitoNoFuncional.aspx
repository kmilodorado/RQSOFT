<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RequisitoNoFuncional.aspx.cs" Inherits="Proyecto_Ing_Software.RequisitoNoFuncional" %>
        ...
        <Items>
            <ext:FormPanel ID="FormPanel1"
               ...
               Width="500"
                ...
                <Items>
                    <ext:FieldSet ID="FieldSet1" runat="server" Title="Información General" >
                        <Items>
                  ...
                  <%--  <ext:FieldSet ID="FieldSet2" runat="server" Title="Autores" DefaultWidth="330">
                    ...
                    <ext:FieldSet ID="FieldSet2" runat="server" DefaultWidth="330">
                        <Items>
                                                        ...
                                                        <BottomBar>
                                                            <ext:PagingToolbar ID="PagingToolbar2" DisplayInfo="false" runat="server" PageSize="5" HideRefresh="true">
                                                                <Items>
                                                                    ...
                                                                    <ext:Button runat="server" ID="Button4" Text="Eliminar" ToolTip="Eliminar" Icon="Delete">
                                                                        <Listeners>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Actor.aspx.cs" Inherits="Proyecto_Ing_Software.Actor" %>
                ...
                <Items>
                    <ext:FieldSet ID="FieldSet1" runat="server" Title="Información General" DefaultWidth="330">
                        <Items>
                            ...
                            <ext:TextField ID="txt_Version" runat="server" FieldLabel="Versión" AnchorHorizontal="95%"  Text="001"  ReadOnly="true" />
                                    ...
                                    <ext:Panel runat="server" ID="panel_autor" Title="Autores">
                                        <Items>
                                            <ext:Container ID="Container5" runat="server" Layout="HBoxLayout">
                                                <Items>
                                                    <ext:ComboBox ID="cbx_autores" runat="server" EmptyText="Seleccione..." AllowBlank="true"
                                                        QueryMode="Local" DisplayField="Nombre" Flex="2" Margins="5 5 5 10" ValueField="Login" TypeAhead="true" ForceSelection="true" AnchorHorizontal="95%" >
                                                        <Store>
                                                        ...
                                                        <ListConfig AnchorHorizontal="95%"  Height="300" ItemSelector=".x-boundlist-item">
                                            ...
                                            <ext:Container ID="Container2" runat="server" Layout="HBoxLayout">
                                                <Items>
                                                    <ext:GridPanel ID="grilla_autores" runat="server" Title="Autores del Actor"
                                    ...
                                    <ext:Panel runat="server" ID="panel_fuente" Title="Fuentes">
                                        <Items>
                                            ...
                                            <ext:Container ID="Container9" runat="server" Layout="HBoxLayout">
                                                <Items>
                                                    <ext:GridPanel ID="grilla_fuentes" runat="server" Title="Fuentes del Actor"
                                                        AutoScroll="true" Collapsible="true" Collapsed="true" Layout="HBoxLayout" Flex="3">
                                                        <Store>
                ...
                <Buttons>
                      <ext:Button ID="Button1"
                        ...
                        <Listeners>
                          ...
                          App.txt_Comentarios.getValue()], [App.grilla_autores.getRowsValues(),App.grilla_fuentes.getRowsValues()])" />
                        </Listeners>
                    </ext:Button>
                    <ext:Button ID="btn_act" 
                        ...
                        <Click Handler="App.direct.actualizar([App.txt_nombre.getValue(), 
                             ...
                             App.txt_Version.getValue() ], [App.grilla_autores.getRowsValues(),App.grilla_fuentes.getRowsValues()])" />
                    </Listeners>
                    </ext:Button>
                </Buttons>
            </ext:FormPanel>
